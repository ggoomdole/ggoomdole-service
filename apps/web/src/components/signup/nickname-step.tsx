  ...
  return (
    <>
      <main className="pb-with-floating-button flex flex-col gap-10 p-5">
        ...
        <div className="focus-within:border-main-900 space-y-1 rounded-2xl border border-gray-100 px-4 py-2.5 transition-colors">
      ...
      <FloatingButton onClick={onClickNext} disabled={!isNicknameValid}>
        다음
      </FloatingButton>
    </>
  );
